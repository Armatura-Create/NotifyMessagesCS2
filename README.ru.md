...
> **Требуется CounterStrikeSharp v1.0.373 или новее.** Начиная с v1.0.369 CSSharp работает на .NET 10,
> и плагин собран под `net10.0` — на более старых сборках CSSharp он не загрузится.

1. Установите [CounterStrikeSharp](https://github.com/roflmuffin/CounterStrikeSharp) (>= v1.0.373) и Metamod:Source
...
ротация рекламных блоков, выбор шаблона для `css_restart_notify`.
...
**Обновление**
- ⬆️ CounterStrikeSharp.API `*` → `1.0.373` (версия зафиксирована), `MinimumApiVersion` 339 → 373
